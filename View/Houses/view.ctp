...
?>&nbsp;
    ...
    <div class="actions">
        <ul>
            ...
            <li><?php echo $this->Html->link(__('View Related 房屋記錄', true), array('controller' => 'house_logs', 'action' => 'index', 'House', $this->data['House']['id']), array('class' => 'HousesViewControl')); ?></li>
        </ul>
    </div>
    <div id="HousesViewPanel"></div>
    <script type="text/javascript">
        //<![CDATA[
        $(function() {
            $('a.HousesViewControl').click(function() {
                $('#HousesViewPanel').parent().load(this.href);
                return false;
            });
        });
        //]]>
